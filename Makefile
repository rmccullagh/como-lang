...
como: ast.o object_api.o comotypes.o ast_node_free.o stack.o ast_compile.o lexer.o parser.o como.o
	$(CC) $(CFLAGS) ast.o object_api.o comotypes.o ast_node_free.o stack.o ast_compile.o parser.o lexer.o como.o $(LIBS) -o como
...
comotypes.o: comotypes.c
	$(CC) $(CFLAGS) -c comotypes.c
